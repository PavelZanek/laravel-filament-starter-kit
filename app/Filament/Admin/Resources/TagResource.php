...
class TagResource extends Resource
{
    ...
    {
        return __('admin/tag-resource.navigation_label');
    }

    #[Override] // @phpstan-ignore-line
    public static function getNavigationGroup(): ?string
    {
        return __('admin/tag-resource.navigation_group');
    }

    #[Override]
    public static function getBreadcrumb(): string
    {
        return __('admin/tag-resource.breadcrumb');
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\IconColumn::make('deleted_at')
                    ...
                    ->state(function (Tag $record): bool {
            ...
            ->actions([
                Tables\Actions\EditAction::make()
                    ->button()
                    ->modalHeading(__('admin/tag-resource.edit.title'))
                    ->successNotificationTitle(__('admin/tag-resource.flash.updated')),
                Tables\Actions\DeleteAction::make()
                    ->button()
                    ->modalHeading(__('admin/tag-resource.actions.modals.delete.single.heading'))
                    ->modalDescription(__('admin/tag-resource.actions.modals.delete.single.description'))
                    ->successNotificationTitle(__('admin/tag-resource.flash.deleted')),
                Tables\Actions\ForceDeleteAction::make()
                    ->button()
                    ->modalHeading(__('admin/tag-resource.actions.modals.force_delete.single.heading'))
                    ->modalDescription(__('admin/tag-resource.actions.modals.force_delete.single.description'))
                    ->successNotificationTitle(__('admin/tag-resource.flash.force_deleted')),
                Tables\Actions\RestoreAction::make()
                    ->button()
                    ->modalHeading(__('admin/tag-resource.actions.modals.restore.single.heading'))
                    ->modalDescription(__('admin/tag-resource.actions.modals.restore.single.description'))
                    ->successNotificationTitle(__('admin/tag-resource.flash.restored')),
            ])
            ->bulkActions([
