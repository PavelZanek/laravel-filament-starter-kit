...
it('may have workspaces', function () {
...
test('cannot access invalid tenant', function () {
...
test('can access valid tenant', function () {
    $user = User::factory()->create();
...
test('get tenants returns workspaces', function () {
    $user = User::factory()->create();
...
test('usersPanel returns admin panel for admin email', function () {
...
test('usersPanel returns app panel for default user', function () {
